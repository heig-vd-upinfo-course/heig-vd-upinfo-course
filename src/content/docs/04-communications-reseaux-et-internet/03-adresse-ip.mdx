...
Vous pouvez comparer l'adresse IP à une adresse postale : pour envoyer une
lettre, vous devez connaître l'adresse du destinataire. De même, pour qu'un
ordinateur envoie des données à un autre, il doit connaître son adresse IP.
L'adresse IP est donc essentielle pour le fonctionnement d'Internet et des
réseaux locaux.
...
- Les **adresses privées** : réservées aux réseaux locaux, elles ne sont pas
  utilisables sur Internet. Les plages les plus courantes sont :
