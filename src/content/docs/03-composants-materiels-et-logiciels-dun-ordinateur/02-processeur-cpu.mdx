...
bits sont appelés x64 ou x86-64. Les processeurs 64 bits peuvent gérer plus de
mémoire et effectuer des calculs plus complexes que les processeurs 32 bits.
Cela permet aux systèmes d'exploitation et aux applications de tirer parti de
performances accrues et de gérer de plus grandes quantités de données.
