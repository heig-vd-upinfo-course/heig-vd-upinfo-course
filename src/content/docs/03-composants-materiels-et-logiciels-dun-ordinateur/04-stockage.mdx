...
Nous parlons de Go et de To pour mesurer la capacité de stockage. 1 To équivaut
à 1 024 Go, et 1 Go équivaut à 1 024 Mo (mégaoctets).
...
De plus, certains caractères spéciaux sont interdits dans les noms de fichiers
et de dossiers sur certains systèmes de fichiers, comme les caractères `/`, `\`,
`:`, `*`, `?`, `"`, `<`, `>`, et `|`. Il est donc préférable de les éviter pour
garantir la compatibilité entre différents systèmes d'exploitation et logiciels,
même si vous arrivez à créer des fichiers ou dossiers avec ces caractères sur
certains systèmes.

Nous recommandons également d'éviter les caractères accentués et les apostrophes
dans les noms de fichiers et dossiers, car ils peuvent causer des problèmes de
compatibilité et de lisibilité sur différents systèmes et logiciels.

Par exemple :

- Nom correct d'un dossier : `mon_projet_2026`.
- Nom incorrect d'un dossier : `Mon Projet 2026` (majuscules).
- Nom correct d'un fichier : `specificites-dun-fichier.png`.
- Nom incorrect d'un fichier : `Spécificités d'un fichier.png` (caractères
  accentués et apostrophe).

Ce ne sont que des conseils ; vous n'êtes pas obligé·e de suivre ces
recommandations.
...
### Exercice pratique 1 - Identifier le type et la capacité de stockage de votre ordinateur
...
2. Tapez "Système" dans la barre de recherche et appuyez sur Entrée.

3. Dans la fenêtre qui s'ouvre, recherchez la section "Spécifications de
   l'appareil" pour voir le type de stockage et la capacité installée sur votre
   ordinateur.
...
3. Sélectionnez "En savoir plus...".

4. Dans la fenêtre qui s'ouvre, vous verrez les informations sur votre stockage.
...
3. Recherchez les lignes "Filesystem" pour voir la capacité de stockage
...
### Exercice pratique 2 - Exercice sur l'arborescence
  ...
  - content
    - docs
      ...
      - 02-premiers-pas-a-la-heig-vd
        ...
        - 08-installer-et-configurer-une-application-2fa.md
      ...
      - 03-composants-materiels-et-logiciels-dun-ordinateur
        ...
        - 10-drivers-et-kernel.md
        - 11-interface-graphique-gui-et-terminal-cli.md
        - 12-applications.md
        - 13-utilisateur-trices-groupes-et-permissions.md
      - 04-communications-reseaux-et-internet
        ...
        - 07-architecture-client-serveur.md
        - 08-effectuer-une-recherche-sur-internet.md
      - 05-configurer-son-systeme-dexploitation-et-ses-applications
        ...
        - 05-gerer-les-mises-a-jour.md
        - 06-services-de-synchronisation-en-ligne.md
        - 07-applications-preinstallees-et-applications-par-defaut.mdx.md
        - 08-applications-au-demarrage.md
        - 09-chiffrement-de-ses-donnees.md
        - 10-anti-virus.md
        - 11-environnement-wsl.md
        - 12-gestionnaires-de-paquets.md
        - 13-mozilla-firefox.md
        - 14-google-chrome.md
        - 15-safari.md
        - 16-un-client-de-messagerie.md
        - 17-un-outil-pour-compresser-decompresser-des-archives.md
        - 18-visual-studio-code.md
        - 19-vlc.md
        - 20-la-suite-microsoft-office.md
        - 21-la-suite-adobe.md
        - 22-git.md
        - 23-docker.md
        - 24-un-outil-pour-traiter-des-documents-pdf.md
        - 25-reinstaller-son-systeme-dexploitation.md
