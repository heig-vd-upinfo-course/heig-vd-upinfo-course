...
Identifiez la touche à presser pour accéder au BIOS/UEFI de votre ordinateur. Il
faudra peut-être consulter le manuel de votre ordinateur ou rechercher en ligne
la combinaison de touches spécifique à votre modèle.

Redémarrez votre ordinateur et appuyez sur cette/ces touche(s) pour entrer dans
le BIOS/UEFI.

Explorez les différentes options disponibles, mais soyez prudent·e et évitez de
modifier des paramètres si vous n'êtes pas sûr·e de leur fonction.
