...
### Exercice pratique 3 - Identifier la version du BIOS/UEFI
...
Si vous le souhaitez, mettez à jour le BIOS/UEFI en suivant les instructions du
fabricant de votre carte mère. Assurez-vous de suivre attentivement les étapes
et de ne pas interrompre le processus de mise à jour, car cela pourrait rendre
