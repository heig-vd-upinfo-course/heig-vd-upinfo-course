...
évitez de modifier des paramètres si vous n'êtes pas sûr de leur fonction.

### Exercice pratique 2

Activez les options de virtualisation dans le BIOS/UEFI de votre ordinateur.
Redémarrez ensuite votre ordinateur après avoir activé cette fonctionnalité.
