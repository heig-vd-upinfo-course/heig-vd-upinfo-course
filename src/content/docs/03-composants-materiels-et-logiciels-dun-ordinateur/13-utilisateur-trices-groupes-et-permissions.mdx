---
title: Utilisateur·trices, groupes et permissions
---
...
quels comptes ou groupes d'utilisateur·trice peuvent accéder à des fichiers, des
dossiers ou des ressources spécifiques et quelles actions ils peuvent effectuer
sur ces éléments.
...
Il existe des mécanismes de sécurité supplémentaires sur les systèmes
d'exploitation pour protéger les comptes d'utilisateur·trice et les données.
...
Accédez aux informations sur les comptes utilisateurs en suivant ces étapes :

<Steps>

1. Cliquez sur le bouton Démarrer.

2. Tapez "Comptes d'utilisateur" dans la barre de recherche et appuyez sur
   Entrée.

3. Dans la fenêtre qui s'ouvre, vous verrez la liste des comptes
   d'utilisateur·trice sur votre ordinateur.
...
3. Sélectionnez "Utilisateurs et groupes" dans le menu de gauche.

4. Dans la fenêtre qui s'ouvre, vous verrez la liste des comptes
   d'utilisateur·trice sur votre ordinateur.
...
1. Rendez-vous dans les paramètres de votre système d'exploitation.

2. Recherchez la section "Comptes" ou "Utilisateurs".
